...
Em.I18n.translations = {
  ...
  'admin.kerberos.wizard.step1.option.ipa.condition.1': 'Cluster hosts are joined to the IPA domain',
  'admin.kerberos.wizard.step1.option.ipa.condition.2': 'A keytab has been generated for an user administrator',
  'admin.kerberos.wizard.step1.option.ipa.condition.3': 'A group has been created that has a password policy that does not expire passwords',
